...
export function FichaDrawer({
  ...
  return (
    ...
    >
      <div
        className="flex h-full w-full max-w-md flex-col bg-[var(--vl-card)] shadow-xl"
        onClick={(e) => e.stopPropagation()}
      >
        <div className="flex items-start justify-between gap-3 border-b border-[var(--vl-card-border)] p-5">
          <div className="min-w-0">
            <Badge className="mb-1 border-slate-300 bg-slate-100 text-slate-600 dark:border-slate-600 dark:bg-slate-800 dark:text-slate-300">
                ...
                {editAsignacion ? (
                  <div className="space-y-2">
                    <select
                      ...
                      className="min-h-11 w-full rounded-md border border-slate-200 p-2 text-sm"
                    >
          ...
          {tab === "historial" && (
            <div className="space-y-2">
              ...
              {historial.map((h) => (
                <div
                  key={h.id}
                  className="flex items-start justify-between gap-3 rounded-lg bg-slate-50 p-2.5 text-sm"
                >
